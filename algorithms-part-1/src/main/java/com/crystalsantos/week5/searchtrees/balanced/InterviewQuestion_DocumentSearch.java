 ...
 * sequence of m query words and find the shortest interval in which 
 * the m query words appear in the document in the order given. 
 * The length of an interval is the number of words in that interval.
 * */
public class InterviewQuestion_DocumentSearch {
